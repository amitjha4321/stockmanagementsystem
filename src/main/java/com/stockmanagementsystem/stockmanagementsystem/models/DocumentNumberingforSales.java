...
@Entity
public class DocumentNumberingforSales {
    @Id
    ...
    public DocumentNumberingforSales(){

    }

    public DocumentNumberingforSales(String name, int prefixNo, int startingPrefixNo, String prefixWord, int suffixNo, int startingSuffixNo, String suffixWord, String displayNo) {
        this.name = name;
    ...
    public String toString() {
        return "DocumentNumberingforSales{" +
                "id=" + id +
                ", name='" + name + '\'' +
                ", prefixNo=" + prefixNo +
